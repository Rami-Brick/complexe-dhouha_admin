        ...
        <div class="flex items-center">
            ...
            <input
                ...
                {{ $getExtraInputAttributeBag()->class([
                    ...
                    'dark:bg-gray-900 dark:text-white dark:focus:border-primary-600' => config('forms.dark_mode'),
                    'dark:text-white dark:placeholder:text-gray-500 dark:disabled:text-gray-400 dark:disabled:[-webkit-text-fill-color:theme(colors.gray.400)] dark:disabled:placeholder:[-webkit-text-fill-color:theme(colors.gray.500)'=> config('forms.dark_mode'),
